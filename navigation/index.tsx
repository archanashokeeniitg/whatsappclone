...
function RootNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: true , headerStyle : { backgroundColor : Colors.light.tint, shadowOpacity : 0}, headerTintColor : Colors.light.background , headerTitleAlign : 'left' }}>
      ...
      <Stack.Screen name="Contacts" component={ContactsScreen} options={({ route }) => ({ title: 'Contacts' , headerRight:() =><View style={{flexDirection : 'row' , width : 60, justifyContent : 'space-between' , marginRight : 20 , }}><Ionicons name="ios-videocam" size={22} color="white" /><Ionicons name="ios-call" size={22} color="white" /></View> })}/>   
